      ...
      <div className="relative overflow-hidden bg-white dark:bg-zinc-800 border-b border-gray-200 dark:border-zinc-700">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20 text-center">
          <div className="inline-flex items-center gap-2 bg-orange-100 dark:bg-orange-900/30 rounded-full px-6 py-3 mb-6 border border-orange-200 dark:border-orange-800">
            ...
            <span className="text-sm font-medium text-orange-700 dark:text-orange-400">Tüm Kategoriler</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            {categories.length} farklı kategoride binlerce ürün arasından en uygun fiyatlı olanını bulun
          </p>

          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <div className="bg-white/60 dark:bg-black/20 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20">
              <span className="text-orange-600 font-semibold">📱 Elektronik</span>
            </div>
            <div className="bg-white/60 dark:bg-black/20 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20">
              <span className="text-blue-600 font-semibold">💻 Bilgisayar</span>
            </div>
            <div className="bg-white/60 dark:bg-black/20 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20">
              <span className="text-green-600 font-semibold">🏠 Ev & Yaşam</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg">
                En çok tercih edilen kategorilerde fiyat karşılaştırması yapın
              </p>
            </div>
            ...
            <div className="text-center mt-16">
              <div className="bg-white dark:bg-zinc-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-zinc-700 max-w-2xl mx-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Ana sayfada arama yaparak istediğiniz ürünü bulabilir ve fiyatları karşılaştırabilirsiniz.
                </p>
                <Link
                  href="/"
