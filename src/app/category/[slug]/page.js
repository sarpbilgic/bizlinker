        ...
        >
          <div className="text-center">
            ...
            >
              ...
              <span className="text-sm font-medium text-orange-700 dark:text-orange-400">Category</span>
            </motion.div>
            <motion.h1 
              variants={slideUp}
            ...
            {!loading && products.length > 0 && (
                <>
                  ...
                  <span className="text-green-600 font-semibold">
                        Lowest: {Math.min(...products.map(p => p.minPrice || p.best_offer?.price || Infinity)).toLocaleString('tr-TR')} ₺
                  </span>
                </div>
                  </div>
                  <div className="bg-white/80 dark:bg-black/20 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/20 shadow-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-blue-600 font-semibold">{filterOptions.businesses.length} business</span>
                    </div>
                  </div>
                  <div className="bg-white/80 dark:bg-black/20 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/20 shadow-lg">
                    <div className="flex items-center gap-2">
                      <ShoppingBagIcon className="w-4 h-4 text-orange-500" />
                      <span className="text-orange-600 font-semibold">{products.length} product</span>
                    </div>
                  </div>
                </>
              )}
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  >
                    ...
                    <option value="savings_desc">Highest Price Difference</option>
                    <option value="stores_desc">Most Sellers</option>
            ...
            <AnimatePresence mode="wait">
              {loading ? (
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Try again by changing the filters.</p>
                </motion.div>
              ) : (
                <motion.div
                  key="products"
