        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-zinc-700/50 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">Make your account more secure</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-zinc-700/50 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">Receive notifications when logging in from new devices</p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-zinc-700/50 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">Receive notifications when the prices of products you follow change</p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-zinc-700/50 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-900 dark:text-white">Stock Alerts</h3>
                <p className="text-xs text-gray-600 dark:text-gray-400">Receive notifications when products you follow are back in stock</p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-zinc-700/50 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">Receive emails for important updates and offers</p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
