...
export default function RegisterForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-white p-6 rounded-lg shadow-md space-y-4">
      ...
      <div className="space-y-1">
        <label htmlFor="userType" className="text-sm font-medium text-gray-700 dark:text-black">
          Kullanıcı Tipi
        </label>
        <select
          id="userType"
      ...
      <button
        type="submit"
        className="w-full bg-orange-500 text-white font-semibold py-2 rounded transition duration-300 mt-3"
      >
        Kayıt Ol
      </button>
    </form>
